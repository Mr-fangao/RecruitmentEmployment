<template>
  <div id="mapContent">
    <iframe id="rythemMap" src="./GraphCType.html" frameborder="0"></iframe>
			...
			var myChart = echarts.init(document.getElementById('main'));
				...
				var option = {
					...
					xAxis: [{
						type: 'category',
						boundaryGap: true,
						data: ['创业','非营利','民营','上市','事业','合资','国企','外资','政府'],
						axisLine:{
							lineStyle:{
								color:'#ffffff',
								width:1,
					...
					series: [{
							...
							type: 'bar',
							stack: '总量',
							data: [12, 2, 1127, 295, 19, 34, 211, 44, 0],
							selected: false
						},
						{ 
							name: '上海',
							type: 'bar',
							stack: '总量',
							data: [13, 2, 1079, 144, 12, 34, 82, 61, 0],
						},
						{ 
							name: '广州',
							type: 'bar',
							stack: '总量',
							data: [27, 6, 1626, 287, 67, 47, 148, 24, 10],
						},
						{ // '创业','非营利','民营','上市','事业','合资','国企','外资','政府'
							name: '深圳',
							type: 'bar',
							stack: '总量',
							data: [6, 0, 719, 186, 4, 17, 33, 22, 3],
						},
						{ // '创业','非营利','民营','上市','事业','合资','国企','外资','政府'
							name: '南京',
							type: 'bar',
							stack: '总量',
							data: [3, 0, 658, 112, 47, 20, 157, 39, 0],
						}
					]
				};
