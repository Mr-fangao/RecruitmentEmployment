<template>
  <div id="mapContent">
    <iframe id="rythemMap" src="./GraphEduc.html" frameborder="0"></iframe>
				...
				var option = {
					...
					series: [{
						...
						},
						{
							...
							type: 'bar',
							stack: '总量',
							data: [11, 278, 1083, 38, 1]
						},
						{
							name: '广州',
							type: 'bar',
							stack: '总量',
							data: [12, 658, 1408, 154, 4]
						},
						{
							name: '深圳',
							type: 'bar',
							stack: '总量',
							data: [9, 239, 660, 108, 8]
						},
						{
							name: '南京',
							type: 'bar',
							stack: '总量',
							data: [10, 192, 729, 44, 4]
						},
					]
				};
